...
The connect command can be used to connect to a EOF
implementation.
...
\hline
Host & ???? EOFsdt & Name you identify the peer with & telmich\\
\hline
Port & ????? EOFsdt & Where we can make the first contact & tcp:10.0.42.42:4242\\
\hline
\end{longtable}
