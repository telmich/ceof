...
IRC is a centralised server architecture, in which the clients connect to one
of the available servers and the servers form a background network.
\center{\includegraphics{irc.eps}}
