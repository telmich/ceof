...
% ----------------------------------------------------------------------------
\subsection{Architecture}
Figure \ref{silcoverview} shows tha
a SILC Network looks similar to an IRC network, which is 
due to its centralised design.
\begin{figure}
    \centering
   ...
   % \footnote{Image source: \url{http://www.silcnet.org/img/silc_network.png}}
\end{figure}
The official SILC Network is run currently being run by 7 SILC servers,
which may be the attack vector for a Denial-of-Service attack.
